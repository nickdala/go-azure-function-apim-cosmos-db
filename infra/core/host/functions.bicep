...
module functions 'appservice.bicep' = {
  ...
  params: {
    ...
    appSettings: union(appSettings, {
        ...
        AzureWebJobsStorage__clientId: storageManagedIdentity ? identityId : null
        AzureWebJobs__clientId: storageManagedIdentity ? identityId : null
        AzureWebJobsStorage__credential: storageManagedIdentity ? 'managedidentity' : null
...
// Remove the post-deployment settings module since we're using WEBSITE_RUN_FROM_PACKAGE='1'
